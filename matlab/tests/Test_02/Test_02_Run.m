...
assert(norm(d_c - d) < 1.0e-04, 'TrussMe - Test_02: Failed to compute displacements.');

% Check force solution
assert(norm(f_c - f) < 3.0e-00, 'TrussMe - Test_01: Failed to compute forces.');

% Test passed
disp('TrussMe - Test_02: Passed.');
