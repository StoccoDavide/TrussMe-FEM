...
assert(norm(d_c - d) < 1.0e-08, 'TrussMe - Test_13: Failed to compute displacements.');

% Check force solution
assert(norm(f_c - f) < 1.0e-08, 'TrussMe - Test_13: Failed to compute forces.');

% Test passed
disp('TrussMe - Test_13: Passed.');
